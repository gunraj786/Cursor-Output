...
if st.session_state.api_configured:
    ...
    # ------------------ Batch Processing Section ------------------
        ...
        <div class="info-box">
            ...
            <p>Process multiple prompts simultaneously using advanced techniques with real-time progress tracking and comprehensive analytics.</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    # ------------------ Vision Analysis Section ------------------
        ...
        <div class="info-box">
            ...
            <p>Upload images and apply sophisticated analysis techniques with detailed insights, expert perspectives, and comprehensive reporting.</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    # ------------------ Analytics Dashboard Section ------------------
        ...
        if not st.session_state.prompt_results:
            ...
            <div class="info-box">
                ...
                <p>Use the prompting techniques, evaluation methods, batch processing, or vision analysis to generate comprehensive analytics data!</p>
            </div>
            """, unsafe_allow_html=True)
            
            # Show sample analytics preview
            st.markdown("### 📊 Analytics Preview")
            st.markdown("Once you start using the platform, you'll see comprehensive analytics including:")
    ...
    #### ⚡ **Batch Processing:**
    - **Concurrent Execution**: Process up to 8 prompts simultaneously
    - **Template Generation**: Create prompts from business templates
    - **Real-time Progress**: Live tracking with performance analytics
    
    #### 🖼️ **Vision Analysis:**
    - **Multi-Image Support**: Analyze multiple images simultaneously
    - **Expert Perspectives**: 6 different professional analysis roles
    - **Focus Areas**: 8 specialized analysis dimensions
    
    #### 📊 **Analytics Dashboard:**
    - **8 Interactive Charts**: Performance trends and insights
...
<div style='text-align: center; color: #666; padding: 1rem;'>
    ...
    <p>Built with Streamlit, Google AI, LangChain & Langfuse | Enterprise-Ready Analytics</p>
</div>
""", unsafe_allow_html=True)